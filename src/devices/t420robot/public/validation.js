...
// 27-03-2019: Radical Electronic Systems, jan@radicalsystems.co.za
// Add URL Validate
...
var Validate = {
   ...
   *                           (DEFAULT: false)
    ...
    URL: function(value, paramsObj){
    	...
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Must be a valid URL or IP address!";
    	//var schemes = paramsObj.schemes || ['mqtt'];
    	var allowLocal = paramsObj.allowLocal || true;
    	
    	if (!Validate.isDefined(value)) {
    		throw new Error("Validate::URL - value not defined!");
            return;
        }

    	if (!Validate.isString(value)) {
    		throw new Error("Validate::URL - not a string");
            return message;
        }
    ...
    /**
    *	author: spme@eagle.co.za !Dankie Inkvis
    *	validates that the field has a valid IP Address
    *
    *	@var obj {mixed} - IP Address to be checked
    *	@var paramsObj {Object} - parameters for this particular validation, see below for details
    *
    *	paramsObj properties:
    *							failureMessage {String} - the message to show when the field fails validation
    *													  (DEFAULT: "Must be a valid IP Address/Subnet Mask!")
    */
   IPAddress: function(obj, paramsObj){
       var paramsObj = paramsObj || {};
       var message = paramsObj.failureMessage || "IP Address format invalid";
       var ary = obj.split(".");
       var ip = true;
